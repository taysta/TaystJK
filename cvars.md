...
<p class="page-lede">1,441 case-insensitive cvar names, with defaults, flags, accepted values, renderer scope, and provenance.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="cvar" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" aria-labelledby="catalog-title">
