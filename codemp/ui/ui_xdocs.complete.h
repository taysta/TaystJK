...
XDOCS_CVAR_DEF("cg_thirdPersonFlagAlpha", "Custom transpareny of the CTF flag",""
)
...
XDOCS_CVAR_DEF("cl_ratioFix", "Fixes the widescreen ratio",
	SETTING("0", "Widescreen ratio is stretched") NL
	SETTING("1", "Widescreen ratio is fixed")
)
