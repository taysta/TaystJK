...
wide: true
reference_app: true
description: "Browse 87 cvars, 55 commands in the TaystJK console reference."
---

<div class="page-heading" markdown="1">
<p class="eyebrow">Filtered collection</p>
<h1>engine-shared</h1>
<p class="page-lede">Entries whose primary registration or dispatch context is this module. This collection contains 87 cvars, 55 commands.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="all" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" data-preset-module="engine-shared" aria-labelledby="catalog-title">
