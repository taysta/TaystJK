...
wide: true
reference_app: true
description: "Browse 247 cvars, 20 commands in the TaystJK console reference."
---

<div class="page-heading" markdown="1">
<p class="eyebrow">Filtered collection</p>
<h1>renderer</h1>
<p class="page-lede">Entries whose primary registration or dispatch context is this module. This collection contains 247 cvars, 20 commands.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="all" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" data-preset-module="renderer" aria-labelledby="catalog-title">
