...
wide: true
reference_app: true
description: "Browse 129 cvars in the TaystJK console reference."
---

<div class="page-heading" markdown="1">
<p class="eyebrow">Filtered collection</p>
<h1>rd-dedicated</h1>
<p class="page-lede">129 cvars are registered by this backend; 11 are exclusive to it in the current tree. Origin is determined separately from backend scope. This collection contains 129 cvars.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="cvar" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" data-preset-renderer="rd-dedicated" aria-labelledby="catalog-title">
  <div class="catalog-heading">
    <div>
      <p class="section-kicker">Console index</p>
      <h2 id="catalog-title">Find a cvar</h2>
    </div>
