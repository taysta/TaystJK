...
wide: true
reference_app: true
description: "Browse 18 cvars, 32 commands in the TaystJK console reference."
---

<div class="page-heading" markdown="1">
<p class="eyebrow">Filtered collection</p>
<h1>Administration</h1>
<p class="page-lede">Entries grouped by feature name, prefix, behavior, and registration context. This collection contains 18 cvars, 32 commands.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="all" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" data-preset-category="Administration" aria-labelledby="catalog-title">
