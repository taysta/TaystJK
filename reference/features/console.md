...
<h1>Console</h1>
<p class="page-lede">Related controls for this configurable feature. This collection contains 12 cvars.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="all" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" data-preset-feature="Console" aria-labelledby="catalog-title">
