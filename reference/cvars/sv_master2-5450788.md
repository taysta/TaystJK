...
| In-game xdocs | No |
| In-game menu | No |
| Default | `master.jkhub.org` <span class="meta-chip">from JKHUB_MASTER_SERVER_NAME</span> |
| Value type | `string` |
...
- Upstream registration evidence: [codemp/server/sv_init.cpp:860](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/codemp/server/sv_init.cpp#L860)
...
- registration: [codemp/server/sv_init.cpp:1022](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/server/sv_init.cpp#L1022) (Cvar_Get)
