...
Controls `r_DynamicGlowHeight` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
|:--|:--|:--|:--|
| `240` | `renderer` | `rd-dedicated` | `always` |
| `240` | `renderer` | `rd-rend2` | `always` |
| `240` | `renderer` | `rd-vanilla` | `always` |
| `240` | `renderer` | `rd-vulkan` | `always` |
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1108](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1108)
...
| `2018-03-29` | <span class="label ref-origin ref-origin-eternaljk">EternalJK</span> | [`f768a9d0b3b1`](https://github.com/eternalcodes/EternalJK/commit/f768a9d0b3b10086974b9c9a01b620549d13915e)<br>Scaled DynamicGlow image by 1/2 screen resolution | Changed registration, default, flags, module, renderer scope, handler, or gating; and an exact bound cvar-variable reference. `codemp/rd-vanilla/tr_image.cpp`, `codemp/rd-vanilla/tr_init.cpp` | `medium` |
...
| `2023-10-12` | <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | [`4e70f99020eb`](https://github.com/taysta/TaystJK/commit/4e70f99020eb16211d4e288637304588e7db5e52)<br>A few small bugfixes | Changed registration, default, flags, module, renderer scope, handler, or gating. `codemp/rd-vanilla/tr_init.cpp`, `codemp/rd-vulkan/tr_init.cpp` | `medium` |

## Evidence

- registration: [codemp/rd-dedicated/tr_init.cpp:332](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L332) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1513](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1513) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1649](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1649) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:801](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L801) (Cvar_Get)
- behavior: [codemp/rd-vanilla/tr_image.cpp:1546](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_image.cpp#L1546)
- behavior: [codemp/rd-vanilla/tr_image.cpp:1553](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_image.cpp#L1553)
