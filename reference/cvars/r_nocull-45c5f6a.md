...
Controls `r_nocull` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
|:--|:--|:--|
| `0` | Disabled. | [codemp/rd-dedicated/tr_main.cpp:56](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_main.cpp#L56) |
| `1` | Enabled. | [codemp/rd-dedicated/tr_main.cpp:56](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_main.cpp#L56) |
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1214](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1214)
...
| `2014-01-30` | <span class="label ref-origin ref-origin-openjk">OpenJK</span> | [`d3a6d2b9b9d2`](https://github.com/JACoders/OpenJK/commit/d3a6d2b9b9d2e967676dc2c9f738254b54524ab2)<br>[MP] Style: remove superfluous whitespace | Changed an exact bound cvar-variable reference. `codemp/rd-vanilla/tr_world.cpp` | `medium` |
...
| `2024-02-03` | <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | [`0c789787f79c`](https://github.com/taysta/TaystJK/commit/0c789787f79c23c977ebb59cc96a6d4d97815f69) · [PR #110](https://github.com/taysta/TaystJK/pull/110)<br>Rend2 updates (#110) | Changed an exact bound cvar-variable reference. `shared/rd-rend2/tr_local.h`, `shared/rd-rend2/tr_main.cpp`, `shared/rd-rend2/tr_world.cpp` | `medium` |

## Evidence

- registration: [codemp/rd-dedicated/tr_init.cpp:413](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L413) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1666](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1666) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1723](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1723) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:885](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L885) (Cvar_Get)
- behavior: [codemp/rd-dedicated/tr_main.cpp:56](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_main.cpp#L56)
- behavior: [codemp/rd-vanilla/tr_main.cpp:61](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_main.cpp#L61)
- behavior: [codemp/rd-vanilla/tr_main.cpp:130](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_main.cpp#L130)
- behavior: [codemp/rd-vanilla/tr_world.cpp:124](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_world.cpp#L124)
- behavior: [codemp/rd-vanilla/tr_world.cpp:1380](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_world.cpp#L1380)
