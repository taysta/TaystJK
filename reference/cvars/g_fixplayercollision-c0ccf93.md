...
| Confidence | `medium` |
| Added | 2020-06-14 in [`fb24d6a98`](https://github.com/taysta/TaystJK/commit/fb24d6a989657d508aa3c722e53dc203d6327e69) <span class="status-chip">needs review</span> — [how to compare this against your build](/TaystJK/whats-new/#how-to-tell-what-your-build-has) |
| In-game xdocs | No |
| In-game menu | No |
| Default | `0` |
| Value type | `bool` |
