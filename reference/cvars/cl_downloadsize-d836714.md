...
Controls `cl_downloadSize` in the engine-client module. Consult the cited behavior reads before relying on values not listed here.
...
| `clc.downloadSize` | `engine-client` | `—` | `always` |
...
| `2024-03-21` | <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | [`2a5ea5d885dc`](https://github.com/taysta/TaystJK/commit/2a5ea5d885dc6c081b75631334aac405da3fa36d) · [PR #169](https://github.com/taysta/TaystJK/pull/169)<br>HTTP Auto Download (Server + Client) (#169) | Changed an exact bound cvar-variable reference. `codemp/client/cl_parse.cpp` | `medium` |

## Evidence

- registration: [codemp/client/cl_main.cpp:1589](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/client/cl_main.cpp#L1589) (implicit Cvar_Set)
- registration: [codemp/client/cl_parse.cpp:667](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/client/cl_parse.cpp#L667) (implicit Cvar_SetValue)
- registration: [codemp/client/cl_parse.cpp:768](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/client/cl_parse.cpp#L768) (implicit Cvar_SetValue)
- behavior: [codemp/ui/ui_main.c:12119](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/ui/ui_main.c#L12119)
