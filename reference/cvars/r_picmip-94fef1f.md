...
Controls `r_picmip` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
- `0` through `16` (integer; Cvar_CheckRange). Evidence: [codemp/rd-dedicated/tr_init.cpp:334](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L334)
- `0` through `16` (integer; Cvar_CheckRange). Evidence: [codemp/rd-rend2/tr_init.cpp:1521](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1521)
- `0` through `16` (integer; Cvar_CheckRange). Evidence: [codemp/rd-vanilla/tr_init.cpp:1652](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1652)
- `0` through `16` (integer; Cvar_CheckRange). Evidence: [codemp/rd-vulkan/tr_init.cpp:804](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L804)
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1114](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1114)
...
| `2013-11-10` | <span class="label ref-origin ref-origin-openjk">OpenJK</span> | [`93ee28a91a3e`](https://github.com/JACoders/OpenJK/commit/93ee28a91a3e30011fc7a4528bef090263a2b83e)<br>[MP] Removed Texture3D unused stuff. | Changed an exact bound cvar-variable reference. `codemp/rd-vanilla/tr_image.cpp` | `medium` |
...
| `2018-01-24` | <span class="label ref-origin ref-origin-eternaljk">EternalJK</span> | [`8365e2db3b6b`](https://github.com/eternalcodes/EternalJK/commit/8365e2db3b6b632713f8c6f35cf3d84275fabd99)<br>Alt+tabbing now triggers chat bubble. | Changed an exact bound cvar-variable reference. `codemp/rd-vanilla/tr_init.cpp` | `medium` |
...
| `2024-02-03` | <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | [`0c789787f79c`](https://github.com/taysta/TaystJK/commit/0c789787f79c23c977ebb59cc96a6d4d97815f69) · [PR #110](https://github.com/taysta/TaystJK/pull/110)<br>Rend2 updates (#110) | Changed an exact bound cvar-variable reference. `shared/rd-rend2/tr_image.cpp`, `shared/rd-rend2/tr_local.h` | `medium` |
| `2026-06-01` | <span class="label ref-origin ref-origin-vulkan">Vulkan</span> | [`22e66aeb32fc`](https://github.com/taysta/TaystJK/commit/22e66aeb32fca7ac91de70bc3474e4d23f38a8fa) · [PR #315](https://github.com/taysta/TaystJK/pull/315)<br>Merge pull request #315 from taysta/vk-up | Changed an exact bound cvar-variable reference. `codemp/rd-vulkan/vk_image.cpp` | `medium` |
| `2026-07-30` | <span class="label ref-origin ref-origin-rend2">rend2</span> | [`aac7dcccc4e7`](https://github.com/taysta/TaystJK/commit/aac7dcccc4e72797666b42058e5d58a6805c1462) · [PR #350](https://github.com/taysta/TaystJK/pull/350)<br>Merge pull request #350 from taysta/rend2-update | Changed an exact bound cvar-variable reference. `shared/rd-rend2/tr_image.cpp` | `medium` |

## Evidence

- registration: [codemp/rd-dedicated/tr_init.cpp:333](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L333) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1520](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1520) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1651](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1651) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:803](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L803) (Cvar_Get)
- behavior: [codemp/rd-rend2/tr_init.cpp:1326](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1326)
- behavior: [codemp/rd-vanilla/tr_image.cpp:601](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_image.cpp#L601)
- behavior: [codemp/rd-vanilla/tr_init.cpp:1516](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1516)
- behavior: [codemp/rd-vulkan/vk_image.cpp:620](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/vk_image.cpp#L620)
- behavior: [codemp/rd-vulkan/vk_image.cpp:621](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/vk_image.cpp#L621)
