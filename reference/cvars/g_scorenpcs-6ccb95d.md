...
| Confidence | `medium` |
| Added | 2018-10-02 in [`3340e21e2`](https://github.com/taysta/TaystJK/commit/3340e21e273b5f68f4e617ac35b38bedc5d34d81) <span class="status-chip">needs review</span> — [how to compare this against your build](/TaystJK/whats-new/#how-to-tell-what-your-build-has) |
| In-game xdocs | No |
| In-game menu | No |
| Default | `2` |
| Value type | `int` |
