...
Controls `r_DynamicGlowDelta` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
|:--|:--|:--|:--|
| `0.8f` | `renderer` | `rd-dedicated` | `always` |
| `0.8f` | `renderer` | `rd-rend2` | `always` |
| `0.8f` | `renderer` | `rd-vanilla` | `always` |
| `0.8f` | `renderer` | `rd-vulkan` | `always` |
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1104](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1104)
...
- registration: [codemp/rd-dedicated/tr_init.cpp:328](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-dedicated/tr_init.cpp#L328) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1509](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-rend2/tr_init.cpp#L1509) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1645](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-vanilla/tr_init.cpp#L1645) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:797](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-vulkan/tr_init.cpp#L797) (Cvar_Get)
- behavior: [codemp/rd-vanilla/tr_backend.cpp:2222](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-vanilla/tr_backend.cpp#L2222)
- behavior: [codemp/rd-vanilla/tr_backend.cpp:2223](https://github.com/taysta/TaystJK/blame/f4643281440c626cb7e30444c8c392606167a7f8/codemp/rd-vanilla/tr_backend.cpp#L2223)
