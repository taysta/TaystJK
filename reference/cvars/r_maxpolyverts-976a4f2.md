...
Controls `r_maxpolyverts` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
| In-game xdocs | No |
| In-game menu | No |
| Default | `XSTRING( DEFAULT_MAX_POLYVERTS )` |
| Value type | `int` |
...
|:--|:--|:--|:--|
| `XSTRING( DEFAULT_MAX_POLYVERTS )` | `renderer` | `rd-dedicated` | `always` |
| `XSTRING( DEFAULT_MAX_POLYVERTS )` | `renderer` | `rd-rend2` | `always` |
| `XSTRING( DEFAULT_MAX_POLYVERTS )` | `renderer` | `rd-vanilla` | `always` |
| `XSTRING( DEFAULT_MAX_POLYVERTS )` | `renderer` | `rd-vulkan` | `always` |
...
- Upstream registration evidence: [codemp/renderer/tr_init.cpp:1151](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/codemp/renderer/tr_init.cpp#L1151)
...
| `2014-06-23` | <span class="label ref-origin ref-origin-openjk">OpenJK</span> | [`8c620db32261`](https://github.com/JACoders/OpenJK/commit/8c620db32261dca32ba7e85522c2847a5020c4f1)<br>[MP] Remove unnecessary forced int template expansion.  The extra parentheses are required due to min/max macro conflict in q_shared.h. | Changed an exact bound cvar-variable reference. `codemp/rd-dedicated/tr_init.cpp`, `codemp/rd-vanilla/tr_init.cpp` | `medium` |
...
| `2021-10-24` | <span class="label ref-origin ref-origin-vulkan">Vulkan</span> | [`bd3a458a8bb2`](https://github.com/JKSunny/EternalJK/commit/bd3a458a8bb29a0348177f586389b98b5f7592a5)<br>Various fixes and upstream changes from Quake3e | Changed an exact bound cvar-variable reference. `codemp/rd-vulkan/tr_init.cpp` | `high` |
...
- registration: [codemp/rd-dedicated/tr_init.cpp:432](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L432) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1698](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L1698) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1745](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1745) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:908](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L908) (Cvar_Get)
- behavior: [codemp/rd-dedicated/tr_init.cpp:513](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-dedicated/tr_init.cpp#L513)
- behavior: [codemp/rd-rend2/tr_init.cpp:2110](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-rend2/tr_init.cpp#L2110)
- behavior: [codemp/rd-vanilla/tr_init.cpp:1843](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vanilla/tr_init.cpp#L1843)
- behavior: [codemp/rd-vulkan/tr_init.cpp:1088](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/rd-vulkan/tr_init.cpp#L1088)
