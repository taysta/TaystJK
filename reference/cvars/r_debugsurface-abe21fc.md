...
Controls `cv2` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
|:--|:--|:--|
| `0` | Disabled. | [codemp/qcommon/cm_patch.cpp:1671](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/qcommon/cm_patch.cpp#L1671) |
| `1` | Enabled. | [codemp/qcommon/cm_patch.cpp:1671](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/qcommon/cm_patch.cpp#L1671) |
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1220](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1220)
...
| `2021-05-25` | <span class="label ref-origin ref-origin-vulkan">Vulkan</span> | [`c4a9c87ef0e3`](https://github.com/JKSunny/EternalJK/commit/c4a9c87ef0e3171c80fd8c4e24df94e0fa1bcbe4)<br>Added vulkan renderer | Changed an exact bound cvar-variable reference. `codemp/rd-vulkan/vk_debug.cpp` | `high` |
...
| `2024-02-03` | <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | [`0c789787f79c`](https://github.com/taysta/TaystJK/commit/0c789787f79c23c977ebb59cc96a6d4d97815f69) · [PR #110](https://github.com/taysta/TaystJK/pull/110)<br>Rend2 updates (#110) | Changed an exact bound cvar-variable reference. `shared/rd-rend2/tr_local.h`, `shared/rd-rend2/tr_main.cpp` | `medium` |

## Evidence

- registration: [codemp/qcommon/cm_patch.cpp:1668](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/qcommon/cm_patch.cpp#L1668) (Cvar_Get); condition `!defined(BSPC)`
- registration: [codemp/rd-dedicated/tr_init.cpp:419](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-dedicated/tr_init.cpp#L419) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1672](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-rend2/tr_init.cpp#L1672) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1729](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vanilla/tr_init.cpp#L1729) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:891](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/tr_init.cpp#L891) (Cvar_Get)
- behavior: [codemp/qcommon/cm_patch.cpp:1671](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/qcommon/cm_patch.cpp#L1671)
- behavior: [codemp/rd-vanilla/tr_main.cpp:1368](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vanilla/tr_main.cpp#L1368)
- behavior: [codemp/rd-vulkan/vk_debug.cpp:462](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/vk_debug.cpp#L462)
- behavior: [shared/rd-rend2/tr_main.cpp:2127](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/shared/rd-rend2/tr_main.cpp#L2127)
- behavior: [codemp/qcommon/cm_patch.cpp:1673](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/qcommon/cm_patch.cpp#L1673)
