...
Controls `r_lodscale` in the renderer module. Consult the cited behavior reads before relying on values not listed here.
...
|:--|:--|:--|:--|
| `5` | `renderer` | `rd-dedicated` | `always` |
| `5` | `renderer` | `rd-rend2` | `always` |
| `5` | `renderer` | `rd-vanilla` | `always` |
| `5` | `renderer` | `rd-vulkan` | `always` |
...
- Upstream registration evidence: [code/renderer/tr_init.cpp:1153](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/renderer/tr_init.cpp#L1153)
...
| `2021-05-25` | <span class="label ref-origin ref-origin-vulkan">Vulkan</span> | [`c4a9c87ef0e3`](https://github.com/JKSunny/EternalJK/commit/c4a9c87ef0e3171c80fd8c4e24df94e0fa1bcbe4)<br>Added vulkan renderer | Changed an exact bound cvar-variable reference. `codemp/rd-vulkan/tr_ghoul2.cpp` | `high` |
...
- registration: [codemp/rd-dedicated/tr_init.cpp:409](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-dedicated/tr_init.cpp#L409) (Cvar_Get)
- registration: [codemp/rd-rend2/tr_init.cpp:1662](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-rend2/tr_init.cpp#L1662) (Cvar_Get)
- registration: [codemp/rd-vanilla/tr_init.cpp:1719](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vanilla/tr_init.cpp#L1719) (Cvar_Get)
- registration: [codemp/rd-vulkan/tr_init.cpp:881](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/tr_init.cpp#L881) (Cvar_Get)
- behavior: [codemp/rd-vanilla/tr_ghoul2.cpp:926](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vanilla/tr_ghoul2.cpp#L926)
- behavior: [codemp/rd-vanilla/tr_mesh.cpp:210](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vanilla/tr_mesh.cpp#L210)
- behavior: [codemp/rd-vulkan/tr_ghoul2.cpp:956](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/tr_ghoul2.cpp#L956)
- behavior: [codemp/rd-vulkan/tr_ghoul2.cpp:979](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/tr_ghoul2.cpp#L979)
- behavior: [codemp/rd-vulkan/tr_mesh.cpp:187](https://github.com/taysta/TaystJK/blame/77d84176b3b94356d189a4420e1bc5e68c88e1ea/codemp/rd-vulkan/tr_mesh.cpp#L187)
