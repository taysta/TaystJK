...
Runs `CG_TargetCommand_f` in the cgame module.
...
- Upstream registration evidence: [code/cgame/cg_consolecmds.cpp:242](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/code/cgame/cg_consolecmds.cpp#L242)
...
| `2013-09-20` | <span class="label ref-origin ref-origin-openjk">OpenJK</span> | [`689631ef2eca`](https://github.com/JACoders/OpenJK/commit/689631ef2ecaed0633f81983bf422e68c3097cd8)<br>Fix tcmd to directly send as a forward-to-server cmd. Fix tcmd so that it works with crosshair player being 0. | Changed the registered command handler. `codemp/cgame/cg_consolecmds.c` | `medium` |
...
- registration: [codemp/cgame/cg_consolecmds.c:2468](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_consolecmds.c#L2468) (cgame command table)
- handler: [codemp/cgame/cg_consolecmds.c:38](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_consolecmds.c#L38)
