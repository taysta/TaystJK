...
Runs `Svcmd_RenameAccount_f` in the game module.
...
| In-game xdocs | No |
| In-game menu | No |
| Syntax | `renameAccount <username> <new username> <confirm>` |
| Cheat protected | No |
...
- Ultimate-origin introduction: [`d9d510063ce6`](https://github.com/videoP/jaPRO/commit/d9d510063ce680639e6ba060021b6d40ee0c1419) in <span class="label ref-origin ref-origin-japro">jaPRO</span> (content authored `2015-03-17`, integrated `2018-01-01`)
- Upstream registration evidence: [codemp/game/g_svcmds.c:1696](https://github.com/videoP/jaPRO/blame/33d1f1e22ac6db0c17beedbcc419ffef98bbe3c3/codemp/game/g_svcmds.c#L1696)
...
|:--|:--|:--|:--|:--|:--|
| <span class="label ref-origin ref-origin-eternaljk">EternalJK</span> | `2015-03-17` | — | `2018-01-01` | [`d9d510063ce6`](https://github.com/eternalcodes/EternalJK/commit/d9d510063ce680639e6ba060021b6d40ee0c1419) | Shared integration commit |
| <span class="label ref-origin ref-origin-taystjk">TaystJK</span> | `2015-03-17` | — | `2018-01-01` | [`d9d510063ce6`](https://github.com/taysta/TaystJK/commit/d9d510063ce680639e6ba060021b6d40ee0c1419) | Shared integration commit |
| <span class="label ref-origin ref-origin-japro">jaPRO</span> | `2015-03-17` | — | `2018-01-01` | [`d9d510063ce6`](https://github.com/videoP/jaPRO/commit/d9d510063ce680639e6ba060021b6d40ee0c1419) | Ultimate origin |
| <span class="label ref-origin ref-origin-vulkan">Vulkan</span> | `2015-03-17` | — | `2018-01-01` | [`d9d510063ce6`](https://github.com/JKSunny/EternalJK/commit/d9d510063ce680639e6ba060021b6d40ee0c1419) | Shared integration commit |
...
| `2018-02-25` | <span class="label ref-origin ref-origin-eternaljk">EternalJK</span> | [`5d810e556b3b`](https://github.com/eternalcodes/EternalJK/commit/5d810e556b3bad79c3cd964bae7d90ed60fce026)<br>No stun baton ev_fire_weapon event for racemode | Changed the registered command handler. `codemp/game/g_account.c` | `medium` |
...
- registration: [codemp/game/g_svcmds.c:1699](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_svcmds.c#L1699) (game-console command table)
- handler: [codemp/game/g_account.c:2667](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_account.c#L2667)
