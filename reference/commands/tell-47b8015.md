...
- Upstream registration evidence: [codemp/cgame/cg_consolecmds.c:374](https://github.com/JACoders/OpenJK/blame/14cea1563762076974bee277afadbd5bf234c494/codemp/cgame/cg_consolecmds.c#L374)
...
| `2019-03-21` | <span class="label ref-origin ref-origin-eternaljk">EternalJK</span> | [`9e070231c388`](https://github.com/eternalcodes/EternalJK/commit/9e070231c3888d26d3283769d0cdb8adf243fb5c)<br>Chat token cleanup+add chat tokens to print local time (Artemis) | Changed the registered command handler. `codemp/cgame/cg_consolecmds.c` | `medium` |
...
- registration: [codemp/cgame/cg_consolecmds.c:2493](https://github.com/taysta/TaystJK/blame/a15beafad337a07e6a965e5063053ed265a96fe2/codemp/cgame/cg_consolecmds.c#L2493) (cgame command table)
- registration: [codemp/cgame/cg_consolecmds.c:2597](https://github.com/taysta/TaystJK/blame/a15beafad337a07e6a965e5063053ed265a96fe2/codemp/cgame/cg_consolecmds.c#L2597) (forwarded client command table)
- registration: [codemp/game/g_cmds.c:9056](https://github.com/taysta/TaystJK/blame/a15beafad337a07e6a965e5063053ed265a96fe2/codemp/game/g_cmds.c#L9056) (game command table)
...
- handler: [codemp/game/g_cmds.c:2401](https://github.com/taysta/TaystJK/blame/a15beafad337a07e6a965e5063053ed265a96fe2/codemp/game/g_cmds.c#L2401)
