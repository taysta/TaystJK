...
allowed!"
([`Cmd_Race_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L7691)).
...
([`Cmd_Warp_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L7431)),
so a short name can land you on a different course than you meant.

Outside practice mode, toggling `noclip` resets your timer
([`Cmd_Noclip_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L858)).
If the server allows marking a position during a run, `amtelemark` only works while you are
on the ground
([`Cmd_Amtelemark_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L7283)).
...
([`Cmd_Practice_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L7211)).
...
([`g_trigger.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_trigger.c#L1664)).
...
- **Strafebot.** Hold `+button14` and your strafe angle is set for you. It works in practice
  ...
  ([`bg_pmove.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/bg_pmove.c#L15284)).
...
- **`launch`.** [`launch`](/TaystJK/reference/commands/launch-f7c91fe/) `<speed>` throws you
  ...
  ([`Cmd_Launch_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L7130)).
...
([`g_trigger.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_trigger.c#L1660)).
...
| [`rtop`](/TaystJK/reference/commands/rtop-56f7fba/) `<course> <style>` | Top ten times for a course. With no style it shows `jka` ([`Cmd_DFTop10_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_account.c#L6512)). |
...
([`ClientConnect`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_client.c#L2924)).
...
|:--|:--|
| [`strafehelper`](/TaystJK/reference/commands/strafehelper-bdb34b4/) | The strafe helper. `strafehelper 14` toggles the line crosshair ([`cg_consolecmds.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_consolecmds.c#L1123)). |
...
|:--|:--|
| [`cg_raceStart`](/TaystJK/reference/cvars/cg_racestart-e3c5285/) `1` | Keeps your start speed on screen for the whole run, not just the first three seconds ([`hud_strafehelper.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/hud_strafehelper.c#L2428)). |
...
| [`cg_strafeHelper_FPS`](/TaystJK/reference/cvars/cg_strafehelper_fps-c64555f/) | The frame rate the strafe helper calculates for. `0` uses your `com_maxfps`; values above `1000` are treated as `1000` ([`DF_SetFrameTime`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/hud_strafehelper.c#L855)). |
...
| [`cl_timeNudge`](/TaystJK/reference/cvars/cl_timenudge-4435ccb/) `-100` | Kane suggests this on a high ping, to run a high frame rate without "Connection Interrupted" warnings. The client ignores a negative value while you spectate or play a demo ([`cl_cgame.cpp`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/client/cl_cgame.cpp#L990)). |
| [`cg_specCameraMode`](/TaystJK/reference/cvars/cg_speccameramode-95baeef/) | When `1`, the default, spectating someone on a jaPRO server uses their first- or third-person view and camera distance. `0` keeps your own ([`cg_view.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_view.c#L2960)). Your `cg_fov` applies either way. |
...
([`g_cmds.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/game/g_cmds.c#L6919)).
...
corners of a box
([`CG_AddCheckpoint_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_consolecmds.c#L2073)).
...
([`cg_snapshot.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_snapshot.c#L548)).
...
([`CG_SpawnStrafeTrailFromCFG_f`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_consolecmds.c#L725)).
[`clearTrail`](/TaystJK/reference/commands/cleartrail-314b9f6/) `<client #>` removes a trail,
and `-1` removes every trail
([`CG_RemoveStrafeTrail`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_localents.c#L1258)).
...
- [`cg_logStrafeTrail`](/TaystJK/reference/cvars/cg_logstrafetrail-6216305/) `<name>`
  ...
  ([`cg_snapshot.c`](https://github.com/taysta/TaystJK/blame/6ff04c0baf588a89e5ec9361ad7a0992941d7655/codemp/cgame/cg_snapshot.c#L777)).
