...
<p class="page-lede">573 case-insensitive command names, with syntax, arguments, handlers, gating, and provenance.</p>
</div>

<section class="reference-catalog" id="catalog" data-reference-app data-mode="command" data-catalog-url="{{ '/assets/data/catalog.json' | relative_url }}" aria-labelledby="catalog-title">
  <div class="catalog-heading">
    <div>
      <p class="section-kicker">Console index</p>
      <h2 id="catalog-title">Find a command</h2>
    </div>
