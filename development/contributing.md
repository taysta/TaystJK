...
A feature with no setting, such as a new key binding rule, a file format the client now reads,
or a change in how something is drawn, has nothing for the reference to hang itself on. It needs
